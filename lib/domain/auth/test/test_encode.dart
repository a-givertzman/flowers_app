...
void alg(List k) {
  ...
  while (sum != limit) {
    ...
    log(debug_, 'encode z: $z;   z4: $z4;   z5: $z5;   z4z5: $z4z5;   zsum: $zsum');
    log(debug_, 'encode y: $y;   y4: $y4;   y5: $y5;   y4y5: $y4y5;   ysum: $ysum');
    log(debug_, 'encode add1: $add1;   add2: $add2');
    z += ((y << 4) ^ (y >>> 5)) + ysum + add2;
    // note: unsigned right-shift '>>>' is used in place of original '>>', due to lack
    // of 'unsigned' type declaration in JavaScript (thanks to Karsten Kraus for this)
  }
  log(debug_, 'encode y: $y;   z: $z');
}
